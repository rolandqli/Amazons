...
final class Controller {
    ...
    private Command[] _commands = {
        ...
        new Command("manual\\s(white|White)*(black|Black)*$", this:: doManual),
        new Command("auto\\s(white|White)*(black|Black)*$", this:: doAuto),
        new Command("([a-j]\\d+)\\-([a-j]\\d+)\\(([a-j]\\d+)\\)",
                this:: doMove),
        new Command("([a-j]\\d+)\\s([a-j]\\d+)\\s([a-j]\\d+)$", this:: doMove),
        new Command("nothing$", this:: doNothing)
    ...
    /** Do nothing. */
    private void doNothing(Matcher unused) {
    ...
    /** Performs a given move based off of MAT. */
    private void doMove(Matcher mat) {
        _board.makeMove(sq(mat.group(1)),
                sq(mat.group(2)), sq(mat.group(3)));
    }

    /** Change to player to manual based off of MAT. */
    ...
    /** Change player to auto based off MAT. */
